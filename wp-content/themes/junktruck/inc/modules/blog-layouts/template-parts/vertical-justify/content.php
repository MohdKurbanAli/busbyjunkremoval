...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'posts-list__item justify-item' ); ?>>
	<div class="posts-list_item_wrapper">
		...
		<?php if ( has_post_thumbnail() ) : ?>
			<a class="post-thumbnail__link" href="<?php echo esc_url( the_permalink() ); ?>">
				<span class="justify-item__thumbnail" <?php junktruck_post_overlay_thumbnail( junktruck_justify_thumbnail_size(0) );?>></span>
			</a>
		<?php endif; ?>
