...
$image_size 			= ( 'circular' != $blog_post_publish_date ) ? 'junktruck-thumb-760-400' : 'junktruck-thumb-l';
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class('posts-list__item default-item'); ?>>
	...
	<?php } ?>
		...
		<?php junktruck_post_thumbnail( $image_size ); ?>
		...
		<header class="entry-header">
			...
			<h3 class="entry-title"><?php the_title( '<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a>' ); ?></h3>
		</header><!-- .entry-header -->
