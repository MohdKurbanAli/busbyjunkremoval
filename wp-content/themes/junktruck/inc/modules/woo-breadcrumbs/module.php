...
if ( ! class_exists( 'JunkTruck_Woo_Breadcrumbs_Module' ) ) {

	/**
	 * Define JunkTruck_Woo_Breadcrumbs_Module class
	 */
	class JunkTruck_Woo_Breadcrumbs_Module extends JunkTruck_Module_Base {
		...
		public function get_wc_breadcrumbs( $is_custom_breadcrumbs, $args ) {
			...
			$wc_breadcrumbs = new JunkTruck_WC_Breadcrumbs( $args );
