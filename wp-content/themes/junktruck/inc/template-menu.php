...
function junktruck_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'junktruck-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'junktruck_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'junktruck' ),
			) );
 ...
 * @return void
 */
function junktruck_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'junktruck-theme/menu/footer-menu-args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'junktruck' ),
		) );
 ...
 * @return string
 */
function junktruck_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'junktruck-theme/social/list-args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'junktruck_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'junktruck' ),
	), $context, $type );
 ...
 * @return void
 */
function junktruck_set_nav_menu( $args ) {
