...
if ( ! class_exists( 'JunkTruck_Widget_Area' ) ) {

	class JunkTruck_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'junktruck-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'junktruck-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'junktruck-theme/widget_area/classes', $classes, $area_id );
	...
	function junktruck_widget_area() {
		return JunkTruck_Widget_Area::get_instance();
	}

	junktruck_widget_area();
}
