...
$config = array(
	...
	'advanced_import' => array(
		'default' => array(
			'label'    => esc_html__( 'JunkTruck', 'junktruck' ),
			...
			'demo_url' => 'https://ld-wp73.template-help.com/wordpress/prod_12532/v1/',
		),
	),
	'import' => array(
		'chunk_size' => 3,
	...
	'success-links' => array(
		'home' => array(
			'label'  => esc_html__( 'View your site', 'junktruck' ),
			'type'   => 'primary',
			'target' => '_self',
			'icon'   => 'dashicons-welcome-view-site',
			'desc'   => esc_html__( 'Take a look at your site', 'junktruck' ),
			'url'    => home_url( '/' ),
		),
		'customize' => array(
			'label'  => esc_html__( 'Customize your theme', 'junktruck' ),
			'type'   => 'primary',
			'target' => '_self',
			'icon'   => 'dashicons-admin-generic',
			'desc'   => esc_html__( 'Proceed to customizing your theme', 'junktruck' ),
	...
	'export' => array(
		'options' => array(
			...
			'woocommerce_default_country',
				'woocommerce_houseliftingmoving2_page_id',
