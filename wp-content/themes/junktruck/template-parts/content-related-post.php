	...
	<article class="related-post hentry <?php echo esc_attr( $thumb_class ); ?>">
		...
		if ( $settings['image_visible'] ) {
			if ( has_post_thumbnail() ) {
				junktruck_post_thumbnail();
			} else {
				printf('<figure class="post-thumbnail"><a class="post-thumbnail__link" href="%s" aria-hidden="true"><img src="%s" alt="JunkTruck image"></a></figure>',
					esc_url( get_permalink() ),
					esc_url( get_placeholder_url())
				);
			}
		}; ?>
